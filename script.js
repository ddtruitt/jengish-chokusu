...
function fetchWeather(location) {
 	...
 	fetch(apiUrl)
 		.then(
            ...
            // When that is done, THEN we are given the data
	    .then(
	    	function (data) {

	    	console.log("DATA", data)
            // Outputs the data received by the fetch request into the console log
      		renderItems(city, data);
            // Dis

    	}
        // The function is asking 'What do you wanna do with that data?'
    	)
            // ^Presents the data
    	.catch(function (err) {
      		console.error(err);
